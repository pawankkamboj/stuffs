...
ZK_DATA_DIR=${ZK_DATA_DIR:-"/data/appuser/zookeeper/data"}
ZK_DATA_LOG_DIR=${ZK_DATA_LOG_DIR:-"/data/appuser/zookeeper/datalog"}
ZK_LOG_DIR=${ZK_LOG_DIR:-"/data/appuser/zookeeper"}
ZK_CONF_DIR=${ZK_CONF_DIR:-"/data/appuser/zookeeper/conf"}
